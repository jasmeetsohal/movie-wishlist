...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 wow fadeInLeft" data-wow-delay=".3s">
				<img src="images/about/about-company.jpg" alt=""
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="block about-feature-3 wow fadeInDown"
				data-wow-duration="500ms" data-wow-delay=".7s">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="team-member wow fadeInLeft" data-wow-duration="500ms"
					...
					<p class="team_text">Lorem ipsum dolor sit amet, consectetur
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="subtitle text-center wow fadeInDown"
					data-wow-duration="500ms" data-wow-delay=".3s">Our Happy
					Clinets</h2>
				<p class="subtitle-des text-center wow fadeInDown"
				...
				<div class="block">
					<h2 class="title wow fadeInDown" data-wow-delay=".3s"
						...
						<a href="contact.html"
							...
							data-wow-delay=".7s" data-wow-duration="500ms">Contact With
							Me</a>
				</div>
			</div>
